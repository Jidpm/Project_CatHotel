...
async function main() {
  ...
  const standardRoom = await prisma.roomtype.create({
    data: {
      ...
      capacity: "1",
      roomPerNight: 350,
      description: "ห้องพักขนาดกะทัดรัด เหมาะสำหรับแมว 1 ตัว พร้อมอุปกรณ์ครบครัน พื้นที่ 2x3 เมตร เหมาะสำหรับแมว 1 ตัว มีกล้องวงจรปิด ตรวจสอบได้ตลอดเวลา อุปกรณ์ครบครัน: กระบะทราย, ชามน้ำ, คอนโดแมว",
  ...
  const deluxeRoom = await prisma.roomtype.create({
    data: {
      ...
      capacity: "2",
      roomPerNight: 550,
      description: "ห้องพักขนาดใหญ่ เหมาะสำหรับแมว 1-2 ตัว พร้อมพื้นที่เล่นและพักผ่อน พื้นที่ 3x4 เมตร เหมาะสำหรับแมว 1-2 ตัว มีหน้าต่างวิวสวน น้องๆชอบนอนมองวิว พื้นที่เล่นส่วนตัว พร้อมคอนโดแมวขนาดใหญ่และของเล่น",
      roomStatus: "AVAILABLE",
      imageUrl:
  ...
  const suiteRoom = await prisma.roomtype.create({
    data: {
      ...
      capacity: "4",
      roomPerNight: 950,
      description: "ห้องพักระดับพรีเมียม เหมาะสำหรับแมว 3-4 ตัว พร้อมบริการ VIP พื้นที่ 4x5 เมตร เหมาะสำหรับแมว 2-3 ตัว มีห้องนอนแยก พื้นที่เล่นและพื้นที่พักผ่อนแยกกัน พร้อมบริการ VIP เช่น อาหารพิเศษและการดูแลเป็นพิเศษ",
      roomStatus: "AVAILABLE",
      imageUrl:
